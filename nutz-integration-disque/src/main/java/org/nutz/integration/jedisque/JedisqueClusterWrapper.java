...
public class JedisqueClusterWrapper extends Jedisque {

    protected JedisqueCluster jedisqueCluster;
    
    public JedisqueClusterWrapper() {}
    
    public JedisqueClusterWrapper(JedisqueCluster jedisqueCluster) {
        this.jedisqueCluster = jedisqueCluster;
    }
    
    public void setJedisqueCluster(JedisCluster jedisCluster) {
        this.jedisqueCluster = jedisqueCluster;
    }
    
    public JedisCluster getJedisCluster() {
        return jedisqueCluster;
    }

    @Deprecated @Override
    public Set<String> keys(String pattern) {
        HashSet<String> keys = new HashSet<String>();
        for (JedisquePool pool : jedisqueCluster.getClusterNodes().values()) {
            Jedisque jedisque = null;
            try {
                jedisque = pool.getResource();
                keys.addAll(jedisque.keys(pattern));
            } finally {
                if (jedisque != null)
                    jedisque.close();
            }
