...
/**
 * 需要2个配置, 首先在struts.properties加入 struts.objectFactory=org.nutz.integration.struts2.NutObjectFactory<p/>
 * 第二步有2种选择, 推荐在web.xml声明org.nutz.mvc.NutMvcListener, 或者直接 struts.objectFactory.iocArgs=*js,ioc/,*anno,net.wendal.nutzbook
