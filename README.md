...
| [plugins-dict](https://github.com/nutzam/nutzmore/tree/master/nutz-plugins-dict) | ![Maven Central](https://maven-badges.herokuapp.com/maven-central/org.nutz/nutz-plugins-dict/badge.svg) | 针对java常量的全局字典生成 | 测试 | [邓华锋](http://dhf.ink) |
