...
| [nutz-plugins-event](https://github.com/nutzam/nutzmore/tree/master/nutz-plugins-event) | ![Maven Central](https://maven-badges.herokuapp.com/maven-central/org.nutz/nutz-plugins-event/badge.svg) | nutz-plugins-event是一个实现了事件驱动和异步化的nutz框架的插件，方便各模块间解耦。 | 试用 |
