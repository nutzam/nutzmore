...
public class MtxFontBuilder {
	 ...
	 * 
	 * @param tag
	 *            4-byte tag of the table, same format as sfntly.Tag
	 * @param data
	...
	public byte[] build() {
		...
		// Note: we use raw byte[] array for building the final font, because
		// the WritableFontData
		// implementation currently has performance issues with unnecessary
		// copying.
		// TODO(raph): Either refactor this code to use the sfntly font builder,
		// or, failing that,
