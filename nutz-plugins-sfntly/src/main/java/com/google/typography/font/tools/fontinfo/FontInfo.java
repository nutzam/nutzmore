...
public class FontInfo {
	...
	/**
	 * Gets a list containing the platform ID, encoding ID, and format of all
	 * the cmaps in a font
	 *
	 * @param font
	 *            the source font
	...
	/**
	 * Gets a list of code points of valid characters and their names in the
	 * given font.
	 *
	 * @param font
	 *            the source font
	...
	// for the font
	// TODO public static DataDisplayTable listChars(Font font, String
	// charString)

	/**
	 * Gets a list of Unicode blocks covered by the font and the amount each
	 * block is covered.
	 *
	 * @param font
	 *            the source font
		...
		for (int charId : cmap) {
			if (cmap.glyphId(charId) != CMapTable.NOTDEF) {
				...
				if (!coveredScripts.containsKey(scriptCode)) {
					...
					// Set for script already exists, retrieve for character
					// removal
	...
	/**
	 * Gets a list of minimum and maximum x and y dimensions for the glyphs in
	 * the font. This is based on the reported min and max values for each glyph
	 * and not on the actual outline sizes.
	 *
	 * @param font
	 *            the source font
	...
	/**
	 * Gets the size of hinting instructions in the glyph table, both in bytes
	...
	/**
	 * Gets a list of glyphs in the font that are used as subglyphs and the
